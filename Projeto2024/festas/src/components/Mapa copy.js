...
const Mapa = () => {
    ...
    return (
        <div
            className="border p-4 rounded bg-white bg-opacity-90 h-full overflow-y-auto"
            style={{ fontFamily: "serif", color: "#4a2e2a" }}
        >
            ...
            <div className="flex justify-center relative">
                ...
                >
                    {hovered ? (
                        <div className="absolute bg-white border p-2 rounded"></div>
                    ) : (
                        <div className="absolute bg-white border p-2 rounded hidden"></div>
                    )}
                    <div>
                        <PortugalMap />
                    </div>
